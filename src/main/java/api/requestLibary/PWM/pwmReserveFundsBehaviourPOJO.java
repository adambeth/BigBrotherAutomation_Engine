...
public class pwmReserveFundsBehaviourPOJO {
    ...
    public pwmReserveFundsBehaviourPOJO(String delayMs, String reserveTransactionReference, String targetIdentifier, String sourceIdentifier, String reserveResponseCode) {
    ...
    public pwmReserveFundsBehaviourPOJO() {
    }
